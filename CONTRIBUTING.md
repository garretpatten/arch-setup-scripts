...
Use [GitHub Issues](https://github.com/garretpatten/arch-setup-scripts/issues) with the **Bug report** or **Feature request** form. Include Arch version (`pacman -Q archlinux`), desktop vs headless context, commands run, and relevant lines from **`setup_errors.log`** (redact private paths).
